...
const MyReview = () => {
  ...
  const onSubmit = data => {
    ...
    <div className=''>
      ...
      <textarea className=' p-2 form-control is-valid' {...register("comment")} />
      <label className='mt-2 text-success' htmlFor='rating'>Rating :   </label>
      <select id="inlineFormCustomSelectPref"  className='border-success mb-2 p-2 custom-select my-1 mr-sm-2' {...register("rating")} style={{width: '50px'}}>
