  ...
  return (
   <div className='px-2'>
      ...
      <form className='d-flex flex-column  mx-auto' onSubmit={handleSubmit(onSubmit)}>
        ...
        <input style={{outline: 0}} className='p-2 border-0 rounded bg-secondary ' type="url" {...register("img")} required />

        <label htmlFor="name">  Product name :</label>
        <input className='p-2 border-0 rounded bg-secondary ' style={{outline: 0}} {...register("name")} required />

        <label htmlFor="name">  Product Price :</label>
        <input className="w-25 p-2 border-0 rounded bg-secondary" style={{outline: 0}} type='number' {...register("price")} required />
